...
const PRESENTER_PROFILE_DEFAULTS = {
  ...
  profileBanner: readSeedImageDataUrl('banner-presenter.jpg'),
...
const SEED_LISTING_IMAGES = {
  ...
  headphones: readSeedImageDataUrl('headphones.jpg'),
  subleaseRoom: readSeedImageDataUrl('sublease-room.jpg'),
  storageDrawers: readSeedImageDataUrl('storage-drawers.jpg'),
  standingDesk: readSeedImageDataUrl('standing-desk.jpg'),
  shoeRack: readSeedImageDataUrl('shoe-rack.jpg'),
  boardGame: readSeedImageDataUrl('board-game.jpg'),
};
...
const SEED_PROFILE_BANNERS = {
  studyRoom: readSeedImageDataUrl('banner-study-room.jpg'),
  campusTable: readSeedImageDataUrl('banner-campus-table.jpg'),
  lab: readSeedImageDataUrl('banner-lab.jpg'),
  office: readSeedImageDataUrl('banner-office.jpg'),
  apartment: readSeedImageDataUrl('banner-apartment.jpg'),
  workspace: readSeedImageDataUrl('banner-workspace.jpg'),
  campusGreen: readSeedImageDataUrl('banner-campus-green.jpg'),
  cafe: readSeedImageDataUrl('banner-cafe.jpg'),
};
...
const COMMUNITY_PROFILES = [
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.studyRoom,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.campusTable,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.lab,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.office,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.apartment,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.workspace,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.campusGreen,
  ...
  },
  {
    ...
    profileBanner: SEED_PROFILE_BANNERS.cafe,
...
function buildSeedDataset(config) {
  ...
  const listings = [
    ...
    },
    {
      ...
      itemCondition: 'Good',
      pickupHubId: 'reitz',
      itemPicture: SEED_LISTING_IMAGES.headphones,
    ...
    },
    {
      ...
      itemPicture: SEED_LISTING_IMAGES.subleaseRoom,
    ...
    },
    {
      ...
      itemPicture: SEED_LISTING_IMAGES.storageDrawers,
    ...
    },
    {
      ...
      itemCondition: 'Good',
      pickupHubId: 'honors-village',
      itemPicture: SEED_LISTING_IMAGES.standingDesk,
    ...
    },
    {
      ...
      itemCondition: 'Good',
      pickupHubId: 'honors-village',
      itemPicture: SEED_LISTING_IMAGES.shoeRack,
    ...
    },
    {
      ...
      itemCondition: 'Good',
      pickupHubId: 'broward',
      itemPicture: SEED_LISTING_IMAGES.boardGame,
